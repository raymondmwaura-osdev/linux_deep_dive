...
+ This repository contains notes on what I learn about Linux. I aim to go deep into each concept.
+ The notes are not in a strict order, but related topics are grouped in the same directory.
